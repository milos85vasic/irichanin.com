 ...
 */
function proficient_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function proficient_sanitize_css( $css ) {
 ...
 */
function proficient_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function proficient_sanitize_email( $email, $setting ) {
 ...
 */
function proficient_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function proficient_sanitize_html( $html ) {
 ...
 */
function proficient_sanitize_image( $image, $setting ) {
 ...
 */
function proficient_sanitize_nohtml( $nohtml ) {
 ...
 */
function proficient_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function proficient_sanitize_number_range( $number, $setting ) {
 ...
 */
function proficient_sanitize_select( $input, $setting ) {
 ...
 */
function proficient_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function proficient_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function proficient_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}